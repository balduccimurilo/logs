...
public class Dao {
	...
	public void gravarBanco(Operacao op, Connection con) throws SQLException, ParseException {
		...
		PreparedStatement stm = con.prepareStatement(
				"INSERT INTO TRANSACTION ( TRANSACTION_ID, TRANSACTION_TYPE, TERMINAL_ID, SEQUENCE_NB, OPERATOR_ID,"
						...
						+ " SEAL_CD, DATE) VALUES  (nextval('seq_transaction'),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
...
//		stm.setString(1, TRANSACTION_ID.nextval);
